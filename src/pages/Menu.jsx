        ...
        <div className="max-w-[1300px] m-auto max-h-[610px] h-screen flex flex-col lg:flex-col  items-center">
          <div className="w-[85%] h-full py-4 gap-2 flex flex-col">
            <div className="flex justify-between items-center w-full">
              <p className="w-[20%] font-extrabold text-blue-600 text-2xl">
                LIST MENU
              </p>
              ...
              <div className="w-full flex space-x-5">
                {allMenu?.map((items, key) => {
                  return (
                    <div
                      key={key}
                      className="bg-white shadow-lg rounded-xl w-[300px] p-2 px-5 flex flex-col gap-4"
                    >
                      ...
                      <div className="flex gap-x-2 justify-end items-center">
                        ...
                        <Button
                          onClick={() => deletedMenu(items.id)}
                          variant="bg-red-500 hover:bg-red-400"
                        >
                          Delete
                        </Button>
                      </div>
